...
-- Above Average (3 points) – Excellent
-- Men
('balance', 'male', 18, 39, 3, 25, NULL),
('balance', 'male', 40, 59, 3, 20, NULL),
('balance', 'male', 60, NULL, 3, 15, NULL),
-- Women
('balance', 'female', 18, 39, 3, 20, NULL),
('balance', 'female', 40, 59, 3, 15, NULL),
('balance', 'female', 60, NULL, 3, 10, NULL),

-- Average (2 points) – Typical / acceptable
-- Men
('balance', 'male', 18, 39, 2, 15, 24),
('balance', 'male', 40, 59, 2, 10, 19),
('balance', 'male', 60, NULL, 2, 5, 14),
-- Women
('balance', 'female', 18, 39, 2, 12, 19),
('balance', 'female', 40, 59, 2, 7, 14),
('balance', 'female', 60, NULL, 2, 4, 9),

-- Bad (1 point) – Low / requires follow-up
-- Men
('balance', 'male', 18, 39, 1, NULL, 14),
('balance', 'male', 40, 59, 1, NULL, 9),
('balance', 'male', 60, NULL, 1, NULL, 4),
-- Women
('balance', 'female', 18, 39, 1, NULL, 11),
('balance', 'female', 40, 59, 1, NULL, 6),
('balance', 'female', 60, NULL, 1, NULL, 3);
